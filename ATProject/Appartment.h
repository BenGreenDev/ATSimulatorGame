...
class Appartment : public DrawableBase<Appartment>
{
public:
	Appartment(Graphics& gfx);
...
private:
	...
	IndexedTriangleList<Vertex> model = GenericOBJ::MakeOBJ<Vertex>("./Models/Appartment/app.obj", false);
...
private:
	...
	int pricePerUpdate = 30.0f;

	int baseNumberOfHomes = 20;
};