...
class Bank : public DrawableBase<Bank>
{
public:
	Bank(Graphics& gfx);
...
private:
	...
	IndexedTriangleList<Vertex> model = GenericOBJ::MakeOBJ<Vertex>("./Models/Bank/Bank.obj", false);
...
private:
	...
	int incomePerUpdate = 50.0f;
	int numberOfPeopleEmployed = 20;
};