...
class House : public DrawableBase<House>
{
public:
	House(Graphics& gfx);
...
private:
	...
	IndexedTriangleList<Vertex> model = GenericOBJ::MakeOBJ<Vertex>("./Models/House/house.obj", false);
...
private:
	...
	int pricePerUpdate = 5.0f;

	int baseNumberOfHomes = 5;
};