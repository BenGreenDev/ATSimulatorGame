...
class Shop : public DrawableBase<Shop>
{
public:
	Shop(Graphics& gfx);
...
private:
	...
	IndexedTriangleList<Vertex> model = GenericOBJ::MakeOBJ<Vertex>("./Models/Shop/Shop.obj", false);
...
private:
	...
	int incomePerUpdate = 30.0f;
	int numberOfPeopleEmployed = 10;
};