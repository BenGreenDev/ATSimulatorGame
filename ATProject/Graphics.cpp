...
Graphics::Graphics(HWND hWnd)
{
	...
	// Create device & front / back buffers
	...
	//Create depth state
	//This stencil buffer allows for more than just depth. It can be used for other effects such as mirrors.
...
void Graphics::EndFrame()
{
	...
	//Presents the frame on the backbuffer to the screen
	//Sync interval determins the target frame rate
	HRESULT hr;
